...
var tabla_resolucion_fecha;
	...
	function listar() {
		...
		tabla=$('#resolucion_data').dataTable({
			...
			"ajax":
			{
				url:'../ajax/resolucion.php?op=buscar_resolucion_institucion',//enviamos el parametro 
	...
	$(document).on('click','.detalle_institucion',function () {
		...
		$("#resolucion_detalle_modal_ie").modal('show');
	...
	$(document).on('click','.detalle_institucion',function () {
		...
		var id_resolucion=$(this).attr("id");
				...
				tabla_institucion=$('#detalle_institucion').dataTable({
					...
					"ajax":
					{
						...
						url:'../ajax/resolucion.php?op=detalle_institucion',//enviamos el parametro 
						method:"POST",
						data:{id_resolucion:id_resolucion},
						type:"get",//el tipo del parametro
						dataType:"json",//formato de la data
		...
		if (mes!="" && ano!="") {
			...
			var	tabla_resolucion_fecha = $("#resolucion_fecha_data").dataTable({
					...
					"ajax":
					{
						...
						url:'../ajax/resolucion.php?op=resolucion_fecha_institucion',//enviamos el parametro 
