        ...
        <form id="resolucion_form_in">
          ...
          <div class="card shadow mb-4">
            ...
            <div class="card-header">
              <h5 class="m-0 font-weight-bold text-primary"><i class="fa fa-user"></i>&nbsp; Info - Usuarios
                <button type="button" id="#" class="btn btn-primary float-right listar_usuario" data-toggle="modal" data-target="#listar_usuarios_modal"><i class="fa fa-user-plus" aria-hidden="true"></i></button>
              </h5>
            </div>
            ...
            <div class="card-body">
                ...
                <div class="row">
                  <div class="form-group col-md-6">
                    <div class="input-group">
                      ...
                      <input class="form-control" id="buscar_res" type="text" onkeyup="this.value=NumText_ar(this.value)" placeholder="Buscar Usuarios ..." maxlength="50">
                    </div>
                  </div>
                ...
                <table class="table table-bordered table-hover" width="100%" cellspacing="0">
                  ...
                  <tbody id="listar_usuarios_resolucion">
...
<!--importamos el modal-->
<?php require_once("modal/resolucion_usuarios.php"); ?>
<!--para el footer-->
...
$(document).ready(function(){
  $("#buscar_res").on("keyup", function() {
    ...
    $("#listar_usuarios_resolucion tr").filter(function() {
