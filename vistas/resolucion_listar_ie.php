  	...
  	<div class="form-row">
        <div class="col-md-12">
          <div class="card shadow mb-4">
            ...
            <?php require_once("modal/resolucion_detalle_ie.php"); ?>
            <?php require_once("modal/agregar_ie.php"); ?>
            <?php require_once("modal/agregar_receptor.php"); ?>
            <!--Abrimos el modal para detalle-->
...
<script type="text/javascript" src="js/resolucion_institucion/resolucion_detalle.js"></script>
<script>
